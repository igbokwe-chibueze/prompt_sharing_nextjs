...
export const RepeatIcon = ({ className, ...rest }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    aria-hidden="true"
...
export const CenterIcon = ({ className, ...rest }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    aria-hidden="true"
...
export const LoadingIcon = ({ className, ...rest }) => (
  <svg 
    viewBox="0 0 16 16" 
    fill="none" 
    aria-hidden="true"
...
export const UserAddIcon = ({ className, ...rest }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    xmlns="http://www.w3.org/2000/svg"
...
export const ChatBubbleIcon = ({ className, ...rest }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    <path stroke-linecap="round" stroke-linejoin="round" 
      ...
      4.483 0 0 1-.923 1.785A5.969 5.969 0 0 0 6 21c1.282 0 2.47-.402 3.445-1.087.81.22 1.668.337 2.555.337Z" 
    />
  </svg>
);
